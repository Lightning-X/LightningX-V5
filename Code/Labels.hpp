#pragma once
#include <array>
inline const std::array<const char*, 645> pedModels = {
...
"MP_M_Marston_01","MP_M_Niko_01","MP_M_ShopKeep_01","MP_S_M_Armoured_01","Player_One","Player_Two","Player_Zero","S_F_M_Fembarber","S_F_M_Maid_01","S_F_M_Shop_HIGH",
...
"S_M_M_MovPrem_01","S_M_M_Paramedic_01","S_M_M_Pilot_01","S_M_M_Pilot_02","S_M_M_Postal_01","S_M_M_Postal_02","S_M_M_PrisGuard_01","S_M_M_Scientist_01","S_M_M_Security_01","S_M_M_SnowCop_01",
...
"U_M_Y_Zombie_01", "S_M_M_MovAlien_01", "S_M_M_MovSpace_01"
};
inline const std::array<const char*, 40> Multiplayerskins = {
	"mp_f_freemode_01","mp_m_freemode_01",
	"mp_f_bennymech_01", "mp_f_boatstaff_01", "mp_f_cardesign_01", "mp_f_chbar_01","mp_f_cocaine_01", "mp_f_counterfeit_01",
	"mp_f_deadhooker","mp_f_execpa_01","mp_f_execpa_02","mp_f_forgery_01",
	"mp_f_helistaff_01","mp_f_meth_01","mp_f_misty_01","mp_f_stripperlite","mp_f_weed_01","mp_g_m_pros_01","mp_m_avongoon",
	"mp_m_boatstaff_01","mp_m_bogdangoon","mp_m_claude_01", "mp_m_cocaine_01","mp_m_counterfeit_01","mp_m_exarmy_01",
	"mp_m_execpa_01","mp_m_famdd_01","mp_m_fibsec_01","mp_m_forgery_01","mp_m_g_vagfun_01","mp_m_marston_01","mp_m_meth_01","mp_m_niko_01",
	"mp_m_securoguard_01","mp_m_shopkeep_01","mp_m_waremech_01","mp_m_weapexp_01","mp_m_weapwork_01","mp_m_weed_01", "mp_s_m_armoured_01"
};
inline const std::array<const char*, 317> Unclassed = {
...
inline const std::array<const char*, 42> Animals = {
	"A_C_Panther", "A_C_Humpback", "A_C_Boar", "A_C_Boar_02", "A_C_Chickenhawk","A_C_Chimp", "A_C_Chimp_02", "A_C_Chop", "A_C_Chop_02", "A_C_Cormorant",
	"A_C_Cow","A_C_Coyote", "A_C_Coyote_02", "A_C_Crow","A_C_Deer", "A_C_Deer_02", "A_C_Fish","A_C_Hen","A_C_Husky","A_C_MtLion", "A_C_MtLion_02", "A_C_Pig","A_C_Pigeon","A_C_Rat","A_C_Retriever",
	"A_C_Rhesus","A_C_Rottweiler", "A_C_Pug", "A_C_Pug_02", "A_C_Poodle","A_C_Westy","A_C_Seagull","A_C_SharkTiger","A_C_Shepherd", "A_C_Cat_01", "A_C_Rabbit_01", "A_C_Rabbit_02", "A_C_KillerWhale", "A_C_SharkHammer",
	"A_C_SharkTiger", "A_C_Dolphin", "A_C_Stingray",
};
inline const std::array<const char*, 174> Storycharacter = {
...
inline const std::array<const char*, 119> Female = {
...
constexpr std::array<const char*, 70> transition_states = {
