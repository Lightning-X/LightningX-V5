...
namespace base
{
	...
	{
	public:
		explicit native_hook(rage::scrProgram* program, const ankerl::unordered_dense::map<rage::scrNativeHash, rage::scrNativeHandler>& native_replacements);
		~native_hook();

	private:
		void hook_instance(rage::scrProgram* program, const ankerl::unordered_dense::map<rage::scrNativeHash, rage::scrNativeHandler>& native_replacements);
