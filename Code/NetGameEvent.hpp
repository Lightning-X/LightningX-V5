...
namespace rage
{
	...
	public:
		...
		{
			return base::g_pointers->m_writeBitbufBool(this, integer, 1);
		}
		bool ReadBool(bool* integer)
		{
			return base::g_pointers->m_readBitbufBool(this, integer, 1);
		}
		...
		{
			return base::g_pointers->m_readBitbufString(this, string, bits);
		}
		bool WriteByte(uint8_t integer, int bits)
		{
			return base::g_pointers->m_writeBitbufDword(this, integer, bits);
		}
		bool ReadByte(uint8_t* integer, int bits)
		{
			uint32_t read;
			if (base::g_pointers->m_readBitbufDword(this, &read, bits))
			{
				*integer = read;
				return true;
			}
		...
		{
			return base::g_pointers->m_readBitbufDword(this, integer, bits);
		}
		bool WriteInt32(int32_t integer, int bits)
		{
			return base::g_pointers->m_writeBitbufInt32(this, integer, bits);
		}
		...
		{
			return base::g_pointers->m_writeBitbufQword(this, integer, bits);
		}
		...
		{
			return base::g_pointers->m_writeBitbufInt64(this, integer, bits);
		}
		...
		{
			return base::g_pointers->m_writeBitbufArray(this, array, size, 0);
		}
		bool ReadArray(PVOID array, int size)
		{
			return base::g_pointers->m_readBitbufArray(this, array, size, 0);
		}
