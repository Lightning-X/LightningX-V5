...
#include "../GTAV-Classes-master/rage/rlGamerInfoBase.hpp"
#include <optional>
#include <string>
...
namespace base
{
	...
	public:
		...
		/*rate_limiter m_host_migration_rate_limit{ 2, 15 };
		rate_limiter m_invites_rate_limit{ 10, 2 };*/
		...
		bool block_all_script_events = false;
